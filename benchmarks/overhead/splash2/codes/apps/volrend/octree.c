...
#line 103
	for (i = 0; i < () - 1; i++) {
#line 103
		Error = pthread_create(&PThreadTable[i], NULL, (void * (*)(void *))(Compute_Base), (void*)thrIndex);
#line 103
    thrIndex++;
#line 103
		if (Error != 0) {
...
#line 118
	for (i = 0; i < () - 1; i++) {
#line 118
		Error = pthread_create(&PThreadTable[i], NULL, (void * (*)(void *))(Or_Neighbors_In_Base), (void*)thrIndex);
#line 118
    thrIndex++;
#line 118
		if (Error != 0) {
...
#line 118
	Or_Neighbors_In_Base((void*)0);
#line 118
}
#endif

  Or_Neighbors_In_Base(curr_index);
...
void Compute_Base(void *vpIndex)
{
...
void Or_Neighbors_In_Base(void *vpIndex)
{
  int index = (unsigned int)vpIndex;
  {
#line 216
