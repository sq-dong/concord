...
#line 152
		Error = pthread_create(&PThreadTable[i], NULL, (void * (*)(void *))(ParallelExecute), (void*)thrIndex);
#line 152
    thrIndex++;
#line 152
		if (Error != 0) {
