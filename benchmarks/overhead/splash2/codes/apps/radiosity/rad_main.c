...
extern __thread long *tlMasterClock __attribute__((used));
...
#ifdef LIBFIBER
    //fiber_manager_init(n_processors); /* Use 1 thread */
...
#line 231
		Error = pthread_create(&PThreadTable[i], NULL, (void * (*)(void *))(radiosity), (void*)thrIndex);
#line 231
    thrIndex++;
#line 231
		if (Error != 0) {
...
#line 235
    ...
    print_timing_stats();
    printf("radiosity runtime: %lu usec\n", run_time);
    {
#line 316
    exit(0);};
    exit(0) ;
