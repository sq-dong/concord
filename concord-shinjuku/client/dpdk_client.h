...
static constexpr size_t MSG_OFFSET_RUNNS = 26;
static constexpr size_t MSG_OFFSET_GENNS = 34;
static constexpr size_t MSG_OFFSET_NETWORKER_RECV_NS = 42;
static constexpr size_t MSG_OFFSET_SERVER_SEND_NS = 50;
static constexpr size_t MSG_OFFSET_NETWORKER_CY = 58;
static constexpr size_t MSG_OFFSET_DISPATCHER_CY = 66;
static constexpr size_t MESSAGE_WIRE_SIZE = 74;
